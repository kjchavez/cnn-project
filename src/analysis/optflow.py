...
plt.scatter(normal_norms,normal,c='b',alpha=0.6)
plt.scatter(uniform_norms,uniform,c='r',alpha=0.6)
plt.scatter(laplace_norms,laplace,c='g',alpha=0.6)
...
fig = plt.figure()
ax = plt.gca()
ax.plot(steps , rel_diff, 'o', c='blue', alpha=1, markeredgecolor='none')
ax.plot(steps , rel_cost, 'o', c='red', alpha=1, markeredgecolor='none')
#ax.set_yscale('log')
ax.set_xscale('log')
